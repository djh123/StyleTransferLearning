...
from ffwd_tool import ffwd_to_img
...
def optimize(content_targets, style_target, content_weight, style_weight,
             ...
             test=False,test_dir='result',checkpoint_dir='checkpoints'):
    if slow:
        batch_size = 1
    ...
    with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            while iterations * batch_size < num_examples:
                ...
                _, _style_loss,_content_loss,_tv_loss,_loss,_preds = sess.run([train_step, style_loss, content_loss, tv_loss, loss, preds], feed_dict=feed_dict)
                ...
                if iterations % 1000 == 0:
                    ...
                    preds_path = '%s/%s_%s.png' % (test_dir,epoch, iterations)
                    if not slow:
